    ...
    return (
        <div className="min-h-screen w-full flex bg-white font-sans overflow-hidden">
            ...
            <motion.div 
                ...
                className="w-full lg:w-1/2 flex flex-col p-8 lg:p-16 relative"
            >
                {/* Branding */}
                <Link href="/" className="flex items-center gap-2 mb-12 lg:mb-20 group">
                ...
                <div className="max-w-md w-full mx-auto my-auto">
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <p className="text-gray-500 font-medium">Log in to access your CRM dashboard and manage your team.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full h-12 bg-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-blue-300 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                    ...
                    <div className="mt-8">
                        <div className="relative mb-8">
                            ...
                            <div className="relative flex justify-center text-xs font-bold uppercase tracking-widest">
                                <span className="px-4 bg-white text-gray-400">Or Log In With</span>
                            </div>
                        </div>
                    ...
                    <p className="mt-12 text-center text-sm font-semibold text-gray-500">
                        ...
                        <Link href={route('register')} className="text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-2 decoration-blue-200 hover:decoration-blue-600 transition-all">
                            Sign Up
                        </Link>
                    </p>
                </div>
            ...
            >
                ...
                <div className="absolute top-0 left-0 w-full h-full">
                    <div className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-blue-500 opacity-20 blur-3xl"></div>
                    <div className="absolute bottom-[-20%] left-[-10%] w-[80%] h-[80%] rounded-full bg-blue-400 opacity-10 blur-3xl"></div>
                </div>

                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-16 text-white text-center">
                    <div className="max-w-xl mb-12">
                        <h2 className="text-5xl font-extrabold mb-6 leading-tight">Effortlessly manage your team and operations.</h2>
                        <p className="text-blue-100 text-lg font-medium opacity-90">Our integrated platform gives you all the tools you need to scale your business from day one.</p>
                    </div>
